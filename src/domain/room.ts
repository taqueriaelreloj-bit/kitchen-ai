...
export function reconstructRoom(photos: ScanPhoto[]): RoomModel {
  ...
  return { id: `room-${photos[0].capturedAt}`, widthM: 3.7, lengthM: 4.2, heightM: 2.45, layout: 'L', openings: [{ type: 'door', wall: 0, widthM: 0.9 }, { type: 'window', wall: 1, widthM: 1.4 }], confidence: 0.82, photos };
}
