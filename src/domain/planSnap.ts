...
import { Bounds2D, objectPlanBounds as physicalObjectPlanBounds } from './viewFitting';
...
export function objectPlanBounds(object:EditorObject,x=object.x,y=object.y):Bounds2D{
  return preciseBounds(physicalObjectPlanBounds(x===object.x&&y===object.y?object:{...object,x,y}));
}
