...
describe('Kitchen AI project integrity',()=>{
  ...
  test('detects duplicate IDs, missing selection and orphan openings',()=>{
    ...
    const duplicateBase={...project.objects.find(object=>object.id==='base-1')!};
    project={...project,objects:[...project.objects.filter(object=>object.id!=='wall-north'),duplicateBase],selectedId:'missing'};
