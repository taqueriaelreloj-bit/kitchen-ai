import { applyCabinetFinish, applyHardware, createEditorProject, isBaseCabinetKind, isTallCabinetKind, isWallCabinetKind, objectDefaults } from '../domain/editor';
...
describe('Professional cabinet families', () => {
  ...
  test('bulk base finish and hardware include tall cabinetry but exclude uppers', () => {
    ...
    const project = { ...createEditorProject(room,design), objects:[pantry,upper] };
